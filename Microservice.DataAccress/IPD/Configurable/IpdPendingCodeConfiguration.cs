...
{
    internal class IpdPendingCodeConfiguration : IEntityTypeConfiguration<IpdPendingCode>
    {
        public void Configure(EntityTypeBuilder<IpdPendingCode> builder)
        {
            builder.ToTable("IpdPendingCode");
