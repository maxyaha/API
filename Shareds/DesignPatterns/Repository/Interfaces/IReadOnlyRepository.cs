...
namespace Shareds.DesignPatterns.Repository.Interfaces
{
    public interface IReadOnlyRepository<T> where T : class
    {
        ...
        Task<IEnumerable<T>> GetAsync(Func<System.Linq.IQueryable<T>, System.Linq.IQueryable<T>> query, CancellationToken token);
        ...
        [SuppressMessage("Microsoft.Design", "CA1006:DoNotNestGenericTypesInMemberSignatures", Justification = "Required for generics support.")]
        Task<TResult> GetAsync<TResult>(Func<System.Linq.IQueryable<T>, TResult> query, CancellationToken token);
    }
}
